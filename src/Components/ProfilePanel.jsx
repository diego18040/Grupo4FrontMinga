...
//   return (
//     <div className="absolute top-[60%] left-1/2 transform -translate-x-1/2 w-[95%] max-w-screen-lg md:max-w-screen-xl bg-white p-8 rounded-lg shadow-lg flex items-center justify-center opacity-100 sm:flex-row flex-col-reverse">
...
//       {/* Imagen de perfil */}
//       <div className="w-full sm:w-1/3 flex justify-center sm:ml-24 sm:mb-0 mb-8 mt-[5vh]">
...
//   return (
//     <div
//       className={`absolute sm:top-[60%] sm:left-1/2 sm:transform sm:-translate-x-1/2 w-full ${
//         /* En móviles ocupa toda la pantalla con espaciado */
//         "h-screen flex flex-col items-center justify-start pt-16"
//       } ${
//         /* Diseño original en pantallas grandes */
//         "sm:w-[150%] sm:max-w-screen-lg sm:md:max-w-screen-xl sm:bg-white sm:p-8 sm:rounded-lg sm:shadow-lg sm:flex sm:items-center sm:justify-center sm:flex-row"
//       }`}
//     >
//       {/* Imagen de perfil */}
//       <div className="w-full sm:w-1/3 flex justify-center sm:ml-24 sm:mb-0 mb-8 mt-[8vh] sm:mt-0">
//         <div className="w-40 h-40 rounded-full overflow-hidden mx-auto mb-4">
//           <img
//             src={imageUrl || "https://via.placeholder.com/150"}
//             alt="Avatar"
...
//       <div className="w-full sm:w-3/4 md:w-[50%] lg:w-[30%] xl:w-[25%] p-3 gap-6">
//         <form>
//           {/* Campo Nombre */}
//           <div className="relative w-full mb-6">
//             <input
...
//             <label
//               htmlFor="name"
//               className={`absolute left-0 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none transition-all duration-200 ${
//                 name ? "text-xs -translate-y-6" : "text-base"
//               }`}
//             >
//               Enter your name
//             </label>
...
//               htmlFor="surname"
//               className={`absolute left-0 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none transition-all duration-200 ${
//                 surname ? "text-xs -translate-y-6" : "text-base"
//               }`}
//             >
//               Enter your surname
//             </label>
...
//               htmlFor="address"
//               className={`absolute left-0 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none transition-all duration-200 ${
//                 address ? "text-xs -translate-y-6" : "text-base"
//               }`}
//             >
//               Enter your address
//             </label>
...
//               htmlFor="imageUrl"
//               className={`absolute left-0 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none transition-all duration-200 ${
//                 imageUrl ? "text-xs -translate-y-6" : "text-base"
//               }`}
//             >
//               Enter the image URL
//             </label>
...
const ProfileForm = () => {
  ...
  return (
    <div className="absolute top-[60%] left-1/2 transform -translate-x-1/2 w-[95%] bg-white p-8 rounded-lg shadow-lg flex items-center justify-center opacity-100 sm:flex-row flex-col-reverse">
      {/* Contenedor principal con medidas relativas */}
      <div className="w-full sm:w-4/4 md:w-[60%] lg:w-[50%] xl:w-[40%] p-10 pt-[6%] gap-6 opacity-100 sm:mr-24 sm:mb-0 mb-8">
        <form>
          {/* Campo Nombre */}
