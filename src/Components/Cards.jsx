...
//       <div className="container mx-auto bg-white rounded-xl lg:p-10 xl:p-30 md:p-0 ">
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
//           {mangas.map(manga => (
//             <div
//               key={manga._id}
//               className="m-2 flex rounded-xl border relative transition-transform duration-200 in-out transform hover:scale-105 cursor-pointer"
...
//                   <h2 className="text-xl font-bold">{manga.title}</h2>ease-
//                   <p className={`${textColorClasses[manga.category_id.name.toLowerCase()]} text-left font-bold text-xl`}>
//                     {manga.category_id.name}
//                   </p>
//                 </div>
//                 <div className='w-[80%] flex'>
//                   <NavLink to={`/mangas/${manga._id}`} className="mt-4 bg-teal-200  text-teal-400 font-bold py-2 px-4 rounded-full hover:bg-teal-300 w-24 h-10  items-center justify-center md:block hidden">
//                     Read
//                   </NavLink>
//                 </div>
//               </div>
