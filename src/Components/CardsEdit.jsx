                        ...
                        >
                            ...
                            <div className="grid place-items-center w-[50%]">
                                ...
                                <div className="grid grid-cols-2">
                                    <div className="w-[80%] flex">
                                        <button className="mt-4 bg-purple-300 text-purple-400 font-bold py-2 px-4 rounded-full hover:bg-teal-300 w-24 h-10">EDIT</button>
                                    </div>
                                    <div className="w-[80%] flex">
                            ...
                            <div className="w-[50%] flex justify-right overflow-hidden">
                                <img
                                    ...
                                    alt={manga.title}
                                    className="w-full h-[200px] md:h-[300px] object-cover rounded-l-[50%] rounded-xl"
                                />
                            </div>
                        </div>
                    ))}
