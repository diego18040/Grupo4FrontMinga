...
// import NewRoleForm from "../Pages/NewRolForm";
...
const NewRole = () => {
  ...
  // Función común para redirigir y pasar el rol seleccionado como estado
  const handleJoin = (selectedRole) => {
    navigate("/NewRoleForm", { state: { role: selectedRole } }); // Enviar estado al redirigir
  };
