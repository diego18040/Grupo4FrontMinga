...
const NewRole = () => {
  ...
  const handleJoin = (selectedRole) => {
    navigate("/NewRoleForm", { state: { role: selectedRole } });
  };
        ...
        <div className="w-full max-w-sm text-center">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <button
              ...
              className="md:w-[40vw] md:h-[14vh] border border-pink-500 text-pink-500 rounded-2xl hover:bg-pink-400 transition-colors bg-gradient-to-br from-pink-300 via-pink-400 to-pink-500 text-transparent bg-clip-text relative flex justify-between items-center px-8"
            >
              {/* Contenedor de las imágenes */}
              <div className="relative flex items-center space-x-2">
                {/* Círculo superior (imagen de persona 1) - Solo visible en pantallas xl */}
