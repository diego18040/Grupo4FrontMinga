...
const Carousel = () => {
    ...
    return (
        <div className="w-[85%] mx-auto">
            <div className="hidden md:flex w-full h-[25vh] bg-gradient-to-br from-pink-300 via-pink-400 to-pink-500 items-center rounded-xl">
                ...
                <div className="flex-1 flex">
                    <div className="flex-1 justify-around flex overflow-visible ">
                        ...
                        <img
                            ...
                            alt="fade"
                            className="w-[50%] ml-[-150px] h-[100%] object-contain	 mt-[-15px]" // Aquí se asegura que la imagen mantenga su contenedor
                        />
                        <img
                            src={currentManga.portadaImage}
                            alt="portada"
                            className="w-[30%] ml-[-90px] h-[90%] object-contain mt-[-50px] rounded-xl" // Aquí se asegura que la imagen mantenga su contenedor
                        />
                    </div>
