...
const Carousel = () => {
    ...
    return (
        <div className="w-full h-[30vh] bg-gradient-to-br from-pink-300 via-pink-400 to-pink-500 flex items-center rounded-xl">
            ...
            <div className="flex-1 flex">
                <div className="flex-1 justify-around flex overflow-visible">
                    <img
                        ...
                        alt="fade"
                        className="w-[50%] ml-[-150px] h-[100%] mt-[-25px]" // Aquí se añade el margen superior negativo
                    />
                    <img
                        src={currentManga.portadaImage}
                        alt="portada"
                        className="w-[30%] ml-[-90px] h-[90%] mt-[-50px] rounded-xl" // Aquí se añade el margen superior negativo
                    />
                </div>
                <div className="flex-1 flex flex-col justify-center p-4">
                    <h2 className="text-white font-montserrat text-2xl font-medium leading-6 text-left">{currentManga.mangaName}</h2>
                    <p className="text-white font-roboto text-base font-normal leading-4 text-left">{currentManga.description}</p>
                </div>
            </div>
